...
static void update_time() {
  ...
  strftime(date_buffer, sizeof("0000-00-00"), "%F", tick_time);
...
static void main_window_load(Window *window) {
  // Create GFont
  s_time_font = fonts_load_custom_font(resource_get_handle(RESOURCE_ID_FONT_SOURCESANSPRO_REGULAR_28));
  s_date_font = fonts_load_custom_font(resource_get_handle(RESOURCE_ID_FONT_SOURCESANSPRO_REGULAR_14));
